      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SettingsTile(
              settingType: 'length',
              backgroundColor: Color.fromRGBO(251, 237, 231, 1), 
              foregroundColor: Color.fromRGBO(211, 130, 95, 1),  
              icon: FontAwesomeIcons.penRuler, 
              title: 'String length', subtitle: '10', actionType: 'button',
            ...
            SettingsTile(
              ...
              icon: Icons.abc, 
              title: 'Letters', subtitle: null, actionType: 'switch',
              stringVal: null, boolVal: appState.letterState,
            ),
            SizedBox(height: 15.h,),
            SettingsTile(
              settingType: 'symbols',
              ...
              stringVal: null, boolVal: appState.sysmbolState,
            ),
            SizedBox(height: 20.h,),
            XtraLargeButton(title: 'Generate', callback: () => print('generate'))
          ],
        ),
      ),
    );
